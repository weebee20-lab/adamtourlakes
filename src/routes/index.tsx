  ...
  return (
    <main>
      <section className="hero-stage relative isolate min-h-svh overflow-hidden lg:min-h-0">
        ...
        <div className="hero-copy relative z-30 mx-auto flex min-h-0 max-w-7xl flex-col justify-end gap-8 px-4 pt-28 pb-16 sm:px-6 lg:min-h-[920px] lg:justify-start lg:gap-6 lg:pt-10 lg:pb-12">
