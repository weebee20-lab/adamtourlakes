  ...
  return (
    <main>
      <section className="hero-stage relative isolate min-h-svh overflow-hidden">
        ...
        <div className="hero-copy relative z-30 mx-auto flex min-h-svh max-w-7xl flex-col justify-end gap-8 px-4 pt-28 pb-16 sm:px-6 lg:justify-between lg:pt-8 lg:pb-16">
