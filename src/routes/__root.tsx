...
export const Route = createRootRoute({
  ...
  head: () => {
    const page = seoHead(
      ...
      "Adam Tourlakes, Head of Solar Sales at Solar Energy Solutions by EcoSmart in Cape Coral. Honest rooftop solar for Southwest Florida homeowners — plus a clear guide to how systems work.",
    );
    return {
      meta: [
        { charSet: "utf-8" },
